...
•	To allow system admin to print report of the property or user list <br><br><br>
...
•	The program can run on BlueJ or command prompt<br><br>

## 3.0 Graphic User Interface (GUI)
Overview of the whole project, please refer to **GUI.pdf** <br><br>
